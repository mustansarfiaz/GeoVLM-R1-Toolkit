...
|---------------|------------------------------------------|-------|-------|-------|-------|-------|-----------------------------|-------|-------|-------|-------|-------|------------------------|-------|-------|-------|-------|-------|
|               | GeoChat-Instruct                          | Small | Med.  | Large | Single| Mult. | NWPU VHR-10 (Zero-Shot)     | Small | Med.  | Large | Single| Mult. | GeoChat-Instruct       | Rouge1| Rouge-L| Meteor| NWPU VHR-10 (ZS) | Rouge1| Rouge-L| Meteor| @0.5 | @0.25 | Rouge1 | Rouge-L | Meteor |
